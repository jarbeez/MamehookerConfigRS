...
FileCopy, %A_WorkingDir%\biosini\biosHOTD2US.ini, %A_WorkingDir%\Demul.ini, 1
Run, nomousy.exe /hide
Run, \RetroBat-TriggerHappy\tools\DemulShooter\DemulShooter.exe -target=demul07a -rom=hotd2
sleep, 1000
Run, Demul.exe -run=naomi -rom=hotd2

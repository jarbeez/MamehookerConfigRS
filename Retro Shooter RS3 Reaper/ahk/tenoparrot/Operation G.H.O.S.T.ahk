...
sleep, 2000
;Run, \RetroBat-TriggerHappy\tools\DemulShooter\DemulShooter.exe -target=ringwide -rom=og -noinput
Run, \RetroBat-TriggerHappy\emulators\teknoparrot\TeknoParrotUi.exe "--profile=OG.xml"
